...
/* #ifndef blas_h */   /* June 2019, changing this */
#if !defined(blas_h) && !defined(refblas_h)
    #define blas_h
    #define refblas_h
    ...
    #define dnrm2 dnrm2_
      ...
      /* June 2019, making these ptrdiff_t */
      void dgemv_(char *TRANS, ptrdiff_t *M, ptrdiff_t *N, double *ALPHA, double *A, ptrdiff_t *LDA,
              double *X, ptrdiff_t *INCX, double *BETA, double *Y, ptrdiff_t *INCY);
      extern double dnrm2_(ptrdiff_t *N, double *X, ptrdiff_t *INCX);
